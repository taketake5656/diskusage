...
public class PermissionRequestActivity extends Activity {
    ...
    private final static String STORAGE_REQUESTED_KEY = "storage_requested";
    private final static String USAGE_ACCESS_REQUESTED_KEY = "usage_access_requested";

    private MountPoint mountPoint;
    private boolean storageRequested;
    private boolean usageAccessRequested;
    ...
    private void requestNextPermission() {
        ...
        if (mountPoint.hasApps() && !isAccessGranted() && !usageAccessRequested) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(android.R.string.cancel, (dialogInterface, i12) ->
                            forwardToDiskUsage())
                    .setOnCancelListener(dialogInterface -> forwardToDiskUsage())
                    .show();
            return;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == DISKUSAGE_REQUEST_CODE) {
            ...
            finish();
                ...
                || requestCode == PERMISSION_REQUEST_EXTERNAL_STORAGE_CODE) {
            requestNextPermission();
        }
    }
